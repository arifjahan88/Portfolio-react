    ...
    <section class="bg-gray-50">
      <div class="max-w-screen-xl px-4 py-12 mx-auto space-y-8 overflow-hidden sm:px-6 lg:px-8">
        <nav class="flex flex-wrap justify-center -mx-5 -my-2">
          ...
          <div class="px-5 py-2">
            <a href="#skills" class="text-base leading-6 text-gray-500 hover:text-gray-900">
              Skills
            </a>
          </div>
          <div class="px-5 py-2">
          ...
          <div class="px-5 py-2">
            <p
              href="#"
              class="text-base leading-6 text-gray-500 hover:text-gray-900 hover:cursor-pointer"
            >
              Blogs
            </p>
          </div>
          ...
          <div class="px-5 py-2">
            <a href="#contacts" class="text-base leading-6 text-gray-500 hover:text-gray-900">
              Contact Me
            </a>
          </div>
        </nav>
        <div class="flex justify-center mt-8 space-x-6">
          ...
          >
            <span class="sr-only">GitHub</span>
            <svg class="w-8 h-9" aria-hidden="true" fill="currentColor" viewBox="0 0 24 24">
              <path
                fill-rule="evenodd"
        ...
        <p class="mt-8 text-base leading-6 text-center text-gray-400">
          © 2023 Arif's Portfolio. All rights reserved.
        </p>
      </div>
    </section>
  );
